...
[tag](https://github.com/warp-drive-engineering/framework/tags) are then pushed to github to preserve the history of what we've published and when.

**Generating A Release**

Once the commit has been tagged, our script publishes the tag as a new [Github Release](https://github.com/warp-drive-engineering/framework/releases) with the associated release notes.
